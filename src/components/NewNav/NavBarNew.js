...
import logo from '../../images/שרון בן דוד לוגו.png';
...
const NavBarNew = () => {
  ...
  const menuItems = ['תחומי המומחיות שלי', 'תהליך העבודה איתי', 'קצת עלי'];
      ...
      {isMenuOpen && windowWidth <= 850 && (
        <div className={styles.mobileMenu}>
          {menuItems.map((item, index) => (
            ...
            <div classsName={styles.center}><img className={styles.image} src={logo} alt="שרון בן דוד לוגו"/></div>
        </div>
      )}
      {windowWidth > 850 && (
