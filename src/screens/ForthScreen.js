...
<div className={styles.description}>לקיחת משכנתא הינה אחת החלטות החשובה בחיינו אשר יכולה להשפיע על מצבו לאורך שנים ולקבוע את גורלנו לכן יש צורך לבצע את התהליך בחשיבה מעמיקה ומתוכננת .
תהליך זה אינו פשוט וקל ויש להתחשב  באתגרים שעומדים בפנינו
</div>
...
<div className={styles.text}>
    ...
    <div className={styles.section}>הבנקאי רואה את אינטרס הבנק – עובד בנק!!!
תפקידי לראות את האינטרס של הלקוח להתאים לו משכנתא ייעודי לו. 
זה לא חוכמה לקחת משכנתה – החוכמה היא לחיות צמוד להחזרי המשכנתא ולא להגיע לקריסה כלכלית
</div>
</div>
</div>
{/* חץ לשלב הבא */}
...
<div className={styles.stepHeader}>מושגי פיננסים</div>
...
<div className={styles.text}>
    ...
    <div className={styles.section}>תהליך לקיחת המשכנתא הוא תהליך מורכב הדורש תכנון פיננסי תחילה ובניית תוכנית מותאמת ללקוח , ליווי צמוד לאורך כל הדרך . עיכוב בתהליך עלול להשפיע על התוצאה הסופית שנקבל
 על כן יש צורך ביועץ אשר ילווה אותכם צעד צעד לאורך כל התהליך וימנע מכם כאב ראש גדול ותסכול 
</div>
</div>
</div>
<div className={styles.step}>
...
<div className={styles.stepHeader}>התמקדות בעיקר</div>
    <div className={styles.section}>כלקוח אתה ממוקד בריביות שזה לא העיקר במשכנתא כפי שמרבית האנשים חשובים
תפקיד היועץ להתמקד בנושאים המהותיים במשכנתא ולא רק בריבית ולהביא ללקוח משכנת מותאמת לצרכיו
</div>
</div>
<div className={styles.icons}>
