...
<div className={styles.text}>
    ...
    הבנקאי רואה את אינטרס הבנק – עובד בנק!!!
תפקידי לראות את האינטרס של הלקוח ולהתאים לו משכנתא ייעודית לו. 
זה לא חוכמה לקחת משכנתא – החוכמה היא לחיות צמוד להחזרי המשכנתא ולא להגיע לקריסה כלכלית
...
<div className={styles.stepHeader}>התמקדות בעיקר</div>
    <div className={styles.section}>
    כלקוח אתה ממוקד בריביות שזה לא העיקר במשכנתא כפי שמרבית האנשים חשובים
