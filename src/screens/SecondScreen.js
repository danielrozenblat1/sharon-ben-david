...
"אלווה אתכם לאורך כל התהליך לקיחת המשכנתא." icon={home} />

<Card  border={true} title="כלכלת המשפחה" description=
"כלכלת המשפחה היא אחד הנושאים הכי רגישים היום - אני כאן כדי לעזור לכם להבין איך להתנהל נכון עם כספכם" icon={home} />


</div>
<div className={styles.row}>
<Card border={true} title="הדרכות פיננסיות" description="מעביר הדרכות פיננסיות יחידניות וזוגיות וביצוע סדנאות לניהול כלכלי +סדנאות לייעוץ משכנתאות." icon={home}/>
...
<div className={styles.row}>
<Card title="מחזור משכנתא" description="נבחן את המשכנתא הנוכחית ונבצע התאמה למשכנתא שלכם לאור תנאי השוק וזאת על מנת להתאימה למצבכם הנוכחי מתוך ראיה לצמצם עלויות – חודשיות  - כוללת" icon={home}  />
...
האם זה אומר שנגמר שלא נוכל  להגשים את רצונכם ? התשובה היא לא 
אנו נבנה תוכנית ונציג אותה לכלל הגורמים על מנת להפוך את הלא ל- כן  באמצעותנו  תגשימו את חלומכם
" icon={home}  />
...
<Card title="רכישת דירה מקבלן" description="הלוואה לרכישת דירה חדשה ישירות מחברת הבנייה, ללא בעלים קודמים. זו אפשרות הינה עבור רוכשים המעוניינים בנכס חדש לחלוטין" icon={home}  />
</div>
<div className={styles.row}>
<Card title="רכישת דירה יד שנייה" description="רכישת דירה  מאדם פרטי – נלווה אתכם משלב התכנון ועד קבלת הכסף
הלוואות  גישור – ברשותכם דירה – רוצים לקנות וטרם מכרתם -  נעזור לכם לקבל את הלוואת גישור על הנכס  הקיים 
" icon={home}  />
